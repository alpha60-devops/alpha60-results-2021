---
layout: default
title: "Alpha60 Swarm Results 2021"
...
- Media Objects
{% capture media_objects %}{% include year-2021-0-media-objects.txt %}{% endcapture %}{{ media_objects | replace: '.md)', '.html)' }}
...
- [Year-2021 data](https://github.com/alpha60-devops/alpha60-results-2021/tree/main/data)
