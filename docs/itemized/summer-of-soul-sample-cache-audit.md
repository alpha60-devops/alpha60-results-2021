...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2021/refs/heads/main/data/geojson.cumulative/summer-of-soul-cumulative-aggregate.geojson.gz" data-map-title="Summer of Soul — summer-of-soul" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Summer of Soul (summer-of-soul) cumulative data map in new window" title="Opens interactive map for Summer of Soul (summer-of-soul) data">Swarm Detail</a>
