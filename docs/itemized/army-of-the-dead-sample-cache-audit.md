...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2021/refs/heads/main/data/geojson.cumulative/army-of-the-dead-cumulative-aggregate.geojson.gz" data-map-title="Army of the Dead — army-of-the-dead" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Army of the Dead (army-of-the-dead) cumulative data map in new window" title="Opens interactive map for Army of the Dead (army-of-the-dead) data">Swarm Detail</a>
