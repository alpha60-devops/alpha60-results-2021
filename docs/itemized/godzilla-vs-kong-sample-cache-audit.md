...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2021/refs/heads/main/data/geojson.cumulative/godzilla-vs-kong-cumulative-aggregate.geojson.gz" data-map-title="Godzilla vs. Kong — godzilla-vs-kong" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Godzilla vs. Kong (godzilla-vs-kong) cumulative data map in new window" title="Opens interactive map for Godzilla vs. Kong (godzilla-vs-kong) data">Swarm Detail</a>
