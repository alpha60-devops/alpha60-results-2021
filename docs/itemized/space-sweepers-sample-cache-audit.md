...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2021/refs/heads/main/data/geojson.cumulative/space-sweepers-cumulative-aggregate.geojson.gz" data-map-title="Space Sweepers — space-sweepers" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Space Sweepers (space-sweepers) cumulative data map in new window" title="Opens interactive map for Space Sweepers (space-sweepers) data">Swarm Detail</a>
