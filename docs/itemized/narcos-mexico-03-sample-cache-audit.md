...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2021/refs/heads/main/data/geojson.cumulative/narcos-mexico-03-cumulative-aggregate.geojson.gz" data-map-title="Narcos Mexico — narcos-mexico-03" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Narcos Mexico (narcos-mexico-03) cumulative data map in new window" title="Opens interactive map for Narcos Mexico (narcos-mexico-03) data">Swarm Detail</a>
