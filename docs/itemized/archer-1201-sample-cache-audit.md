...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2021/refs/heads/main/data/geojson.cumulative/archer-1201-cumulative-aggregate.geojson.gz" data-map-title="Archer — archer-1201" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Archer (archer-1201) cumulative data map in new window" title="Opens interactive map for Archer (archer-1201) data">Swarm Detail</a>
