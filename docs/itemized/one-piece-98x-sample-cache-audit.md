...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2021/refs/heads/main/data/geojson.cumulative/one-piece-98x-cumulative-aggregate.geojson.gz" data-map-title="One Piece 98x — one-piece-98x" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open One Piece 98x (one-piece-98x) cumulative data map in new window" title="Opens interactive map for One Piece 98x (one-piece-98x) data">Swarm Detail</a>
