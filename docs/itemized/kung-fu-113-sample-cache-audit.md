...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2021/refs/heads/main/data/geojson.cumulative/kung-fu-113-cumulative-aggregate.geojson.gz" data-map-title="Kung Fu 2021 — kung-fu-113" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Kung Fu 2021 (kung-fu-113) cumulative data map in new window" title="Opens interactive map for Kung Fu 2021 (kung-fu-113) data">Swarm Detail</a>
