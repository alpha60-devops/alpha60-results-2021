...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2021/refs/heads/main/data/geojson.cumulative/dont-look-up-cumulative-aggregate.geojson.gz" data-map-title="Don&#x27;t Look Up — dont-look-up" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Don&#x27;t Look Up (dont-look-up) cumulative data map in new window" title="Opens interactive map for Don&#x27;t Look Up (dont-look-up) data">Swarm Detail</a>
