...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2021/refs/heads/main/data/geojson.cumulative/mother-android-cumulative-aggregate.geojson.gz" data-map-title="Mother/Android — mother-android" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Mother/Android (mother-android) cumulative data map in new window" title="Opens interactive map for Mother/Android (mother-android) data">Swarm Detail</a>
