...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2021/refs/heads/main/data/geojson.cumulative/witcher-02-cumulative-aggregate.geojson.gz" data-map-title="Witcher — witcher-02" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Witcher (witcher-02) cumulative data map in new window" title="Opens interactive map for Witcher (witcher-02) data">Swarm Detail</a>
