...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2021/refs/heads/main/data/geojson.cumulative/halston-01-cumulative-aggregate.geojson.gz" data-map-title="Halston — halston-01" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Halston (halston-01) cumulative data map in new window" title="Opens interactive map for Halston (halston-01) data">Swarm Detail</a>
