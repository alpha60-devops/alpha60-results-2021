...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2021/refs/heads/main/data/geojson.cumulative/no-time-to-die-cumulative-aggregate.geojson.gz" data-map-title="No Time To Die — no-time-to-die" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open No Time To Die (no-time-to-die) cumulative data map in new window" title="Opens interactive map for No Time To Die (no-time-to-die) data">Swarm Detail</a>
