...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2021/refs/heads/main/data/geojson.cumulative/tomorrow-war-cumulative-aggregate.geojson.gz" data-map-title="The Tomorrow War — tomorrow-war" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open The Tomorrow War (tomorrow-war) cumulative data map in new window" title="Opens interactive map for The Tomorrow War (tomorrow-war) data">Swarm Detail</a>
