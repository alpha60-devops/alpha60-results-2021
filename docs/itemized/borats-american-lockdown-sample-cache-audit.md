...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2021/refs/heads/main/data/geojson.cumulative/borats-american-lockdown-cumulative-aggregate.geojson.gz" data-map-title="Borats American Lockdown — borats-american-lockdown" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Borats American Lockdown (borats-american-lockdown) cumulative data map in new window" title="Opens interactive map for Borats American Lockdown (borats-american-lockdown) data">Swarm Detail</a>
